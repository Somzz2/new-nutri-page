    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.about}>
                ...
                <div className={styles.text}>Eu sou a Ana Carla Falcão, formada em Nutrição com especialidade em Nutrição Clínica. Realizo consultas onlines com ótimo valor e preço.
                    <br/><br/>
